...
const SignUp: FC = () => {
  ...
  const onFinish = (values: any) => {
    ...
    api
      .post('/users', {
        ...values,
        birthDate: `${year}-${month < 10 ? '0' + month : month}-${
          day < 10 ? '0' + day : day
        }`,
        //state: stateFormated,
        //city,
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Checkbox>
            Eu li e concordo com os Termos de Uso e a Política de Privacidade da
            Secretaria de Saúde da Prefeitura de Nazaré da Mata.
          </Checkbox>
        </Form.Item>
